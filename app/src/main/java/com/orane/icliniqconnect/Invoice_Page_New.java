...
public class Invoice_Page_New extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("invoice id",inv_id+"  ");
            Log.e("inv_strfee",inv_strfee+"  ");
            Log.e("qid",qid+"  ");
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    //---------------------------------------------------------
                    String url = Model.BASE_URL + "/sapp/prepareInv?user_id=" + (Model.id) + "&inv_for="+type_val+"&item_id=" + (inv_id) + "&token=" + Model.token + "&enc=1";
    ...
    private class JSON_View_inv extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... urls) {
            ...
            try {
                ...
                Log.e("response",inv_str_response+"  ");
                return true;
            } catch (Exception e) {
                e.printStackTrace();
            }
