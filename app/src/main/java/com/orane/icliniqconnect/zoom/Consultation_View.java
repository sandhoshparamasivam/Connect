package com.orane.icliniqconnect.zoom;
...
import com.orane.icliniqconnect.ExpandableActivity;
import com.orane.icliniqconnect.LoginActivity;
import com.orane.icliniqconnect.Model.Model;
import com.orane.icliniqconnect.Prescription_WebViewActivity;
import com.orane.icliniqconnect.R;
import com.orane.icliniqconnect.Voxeet;
import com.orane.icliniqconnect.chime.MeetingHomeActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		/*btn_joinvideocons.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(MainActivity.this, com.orane.icliniqconnect.zoom.Connect_Home_Actvity.class);
